      ...
      <div className="application">
        ...
        { isLogged === false &&
          ...
          <div className="grid">
            ...
            <div className="editor desktop:col-1-2 relative">
              <div className="m-auto w-1/2 mobile:w-full desktop:py-4">
                <Login />
              </div>
            </div>

            <div className="display desktop:col-1-2" />
          </div>
        }
        ...
        { isLogged === true &&
          ...
          <div className="column h-screen">
            <div>
              <Header projectTitle={app.getPageTitle()} />
            </div>
            <div className="px-4 py-2 grow scroll-y">
              <Switch>
