    ...
    <div style={{ width: 'calc(6rem + 6px + 100px)' }} onClick={onClick}>
      <div className={imageClassName}>
        <div className="p-1 w-full v-center h-center h-full">
          ...
          {!isPreloaded && data.ext && (['jpg', 'jpeg', 'png'].indexOf(data.ext) !== -1 || data.url) &&
          ...
          {!isPreloaded && !data.ext &&
            <div className="border border-white border-3 shadow-outer grow h-full" style={{ backgroundColor: data.id }} />
          }
        </div>
      </div>
